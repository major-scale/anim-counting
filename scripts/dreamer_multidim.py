#!/usr/bin/env python3
"""
DreamerV3 shim for multi-dimensional counting world.
Patches make_env() to recognize the 'multidim' suite, then calls dreamer.main().
"""
...
def make_env(config, mode, id):
    ...
    if suite == "multidim":
        ...
        env = MultiDimCountingWorld(task, seed=config.seed + id)
...
if __name__ == "__main__":
    ...
    # Resolve configs.yaml (bridge scripts first, then dreamerv3-torch)
    ...
    # PyYAML 6.0+ parses scientific notation as strings
