...
class _YAMLCompat:
    """Compatibility shim for old ruamel.yaml safe_load API."""
    @staticmethod
    def safe_load(text):
...
def make_env(config, mode, id):
    ...
    if suite == "dmc":
        ...
        import envs.counting as counting

        env = counting.CountingWorld(task, seed=config.seed + id)
...
if __name__ == "__main__":
    ...
    # Resolve configs.yaml: try local dir first, then DREAMER_DIR env, then home
    ...
    # --- Displacement loss config defaults ---
